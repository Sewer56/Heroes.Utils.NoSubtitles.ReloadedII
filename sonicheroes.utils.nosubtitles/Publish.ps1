...
$solutionName = "sonicheroes.utils.nosubtitles/sonicheroes.utils.nosubtitles.csproj"
$publishName = "sonicheroes.utils.nosubtitles.zip"
...
dotnet publish $solutionName -c Release -r win-x86 --self-contained false -o "$modOutputPath" /p:PublishReadyToRun=true
